...
print(
    "Average time between sends [int in milliseconds] (advised min is 10ms): ")
...
while True:
    ...
    while currentLine != '':
        ...
        sensorName = "sensor" + str(randint(0, sensorNumber-1))
        ...
        if makeDifferent:
            ...
            if randint(0, 1) == 0:
                air_temperature = air_temperature + float(randint(0, 100)) / 10
            else:
                air_temperature = air_temperature - float(randint(0, 100)) / 10
        ...
        duration = randint(averageTimeBetween-averageTimeBetween /
                           2, averageTimeBetween+averageTimeBetween/2)
